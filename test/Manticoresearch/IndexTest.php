...
class IndexTest extends TestCase
{
	...
	public function testStart() {
		...
		$index->addDocuments(
			[
				['id' => 2, 'title' => 'Interstellar', 'plot' => 'A team of explorers travel through a wormhole in'
					. ' space in an attempt to ensure humanity\'s survival.', 'year' => 2014, 'rating' => 8.5,
				],
				['id' => 3, 'title' => 'Inception', 'plot' => 'A thief who steals corporate secrets through the '
				...
				['id' => 4, 'title' => '1917 ', 'plot' => ' As a regiment assembles to wage war'
				...
				['id' => 5, 'title' => 'Alien', 'plot' => ' After a space merchant vessel'
					. ' receives an unknown transmission'.
